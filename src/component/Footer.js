...
import image from '../image/logon.png';
  const Footer = () => {
    return(
      ...
      <div className="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
        <div className="sm:col-span-2 mr-60">
        <a
          ...
          <div className="mt-6 lg:max-w-sm">
            <p className="text-sm ">
              Find a Parking Space In NO Time
            </p>
  
          </div>
        </div>
        <div className="space-y-2 text-sm">
          <p className="text-base font-bold tracking-wide mr-40">
            Contacts
          </p>
          <div className="flex">
            <p className="mr-1 ">Phone: </p>
            <a
              href="tel:056-123-5021"
        ...
        <div>
          ...
          <div className="flex items-center mt-2 space-x-5 ml-20 ">
            <a
              href="/"
          ...
          <p className="mt-4 text-sm ">
            Follow us to get the lates updates and news.  
          </p>
        </div>
      </div>
